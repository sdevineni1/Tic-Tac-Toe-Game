...
def decisionMaker(boardState, depth):
    score, index = minmax(boardState, depth, 2)
    return index
...
if __name__ == "__main__":
    ...
    TopLeft.configure(width = 3, height = 2, background = "#F0F0F0", activebackground = "#F0F0F0", relief = "flat")
    ...
    MidLeft.configure(width = 3, height = 2, background = "#F0F0F0", activebackground = "#F0F0F0", relief = "flat")
    ...
    BotLeft.configure(width = 3, height = 2, background = "#F0F0F0", activebackground = "#F0F0F0", relief = "flat")
    ...
    TopMid.configure(width = 3, height = 2, background = "#F0F0F0", activebackground = "#F0F0F0", relief = "flat")
    ...
    MidMid.configure(width = 3, height = 2, background = "#F0F0F0", activebackground = "#F0F0F0", relief = "flat")
    ...
    BotMid.configure(width = 3, height = 2, background = "#F0F0F0", activebackground = "#F0F0F0", relief = "flat")
    BotMid_window = boardCanvas.create_window(118, 220, anchor=tkinter.NW, window=BotMid)

    TopRight = tkinter.Button(boardCanvas, text = " ", command = topRightPress)
    TopRight.configure(width = 3, height = 2, background = "#F0F0F0", activebackground = "#F0F0F0", relief = "flat")
    ...
    MidRight.configure(width = 3, height = 2, background = "#F0F0F0", activebackground = "#F0F0F0", relief = "flat")
    ...
    BotRight.configure(width = 3, height = 2, background = "#F0F0F0", activebackground = "#F0F0F0", relief = "flat")
    ...
    Score.configure(width = 15, background = "black", activebackground = "white", relief = "flat",font=('courier',10))
